...
First, I create a dataset that contains character-specific questions and
is formatted so that each row represents a single respondent’s answers
on a single character. This way favorability information can easily be
plotted with ggplot.
...
A few conclusions:
  ...
  - Younger people feel less strongly favorable towards Original Trilogy
    characters (C3PO, Han, Luke) and more favorably towards OT villians
    (Vader, Boba Fett)
...
I’ll first get a value for each character indicating how much more
positively those who are familiar with the Expanded Universe feel about
them.
...
how many EU stories expand on Vader, but this leads me to think there
are quite a few.
